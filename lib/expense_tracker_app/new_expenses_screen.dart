...
class _NewExpensesScreenState extends State<NewExpensesScreen> {
  ...
  void _showDialog() {
    ...
    Platform.isIOS
        ? showCupertinoDialog(context: context, builder: (ctx) => dialog)
  ...
  void dispose() {
    ...
    _amountController.dispose(); // Thêm dispose để tránh rò rỉ bộ nhớ
    super.dispose();
  }
                  ...
                  if (width >= 600)
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(
                            width:
                                16), // Thêm khoảng cách giữa TextField và Icon
                        Expanded(
                          child: Row(
                            mainAxisAlignment:
                                MainAxisAlignment.end, // Căn phải
